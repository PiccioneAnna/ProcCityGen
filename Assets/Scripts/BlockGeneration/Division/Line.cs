...
#region reference
/// https://github.com/Szuszi/CityGenerator-Unity/blob/main/CityGenerator2D/Assets/Procedural%20City%20Generator/Scripts/BlockDivision/Line.cs
#endregion
namespace BlockDivision
{
    class Line
    {
        ...
        private Node GetRandomOtherNode()
        {
        ...
        {
            var otherNodeInLine = GetRandomOtherNode();
