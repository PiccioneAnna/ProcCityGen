...
#region reference
/// https://github.com/Szuszi/CityGenerator-Unity/blob/main/CityGenerator2D/Assets/Procedural%20City%20Generator/Scripts/RoadGeneration/RoadSegment.cs
#endregion
namespace RoadGeneration
{
    public class Segment
    {
        ...
        public bool IsCrossing(Segment road) //Check if the given road intersects with this road
        {
        ...
        private int Orientation(Node baseNode1, Node baseNode2, Node testNode) //Orientation can be calculated with the cross product of two Vectors made from the 3 Nodes
        {
            ...
            if (val > 0.001f) return 1; //clockwise
            if (val < -0.001f) return -1; //anticlockwise
